...
\section{Clase en laboratorio}%titulo2 \\ sirven para saltar una linea.
\begin{flushright}
...
%inicio resumen 3
   \section{Trabajando con Github y git}%titulo2 \\ sirven para saltar una linea.
\begin{flushright}
...
\section{Resolviendo un problema con python\\}%titulo2 \\ sirven para saltar una linea.
\begin{flushright}
...
% Inicio res 5
\section{Trabajando con python y LaTeX}%titulo2 \\ sirven para saltar una linea.
\begin{flushright}
...
%inicio res 6
\section{Algoritmos de Python\\}%titulo2 \\ sirven para saltar una linea.
\begin{flushright}
...
%inicio res 7
\section{Funciones para resolver problemas en python}%titulo2 \\ sirven para saltar una linea.
\begin{flushright}
...
\section{Funciones en python}%titulo2 
...
%inicio res 9
	...
	\section{Resolviendo problemas con Python}%titulo2 \\ sirven para saltar una linea.
\begin{flushright}
